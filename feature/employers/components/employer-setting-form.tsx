...
//   "200+ employees",
// ] as const;
// type TeamSize = (typeof teamSizesOptions)[number];

// interface EmployerSettingsForm {
//   name: string;
//   description: string;
//   yearOffStablishment: string;
//   location: string;
//   websiteUrl: string;
...
const EmployerSettingsForm = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      yearOffStablishment: initialData?.yearOffStablishment,
  ...
  //       name: initialData?.name || "",
  //       description: initialData?.description || "",
  //       yearOffStablishment: initialData?.yearOffStablishment?.toString() || "",
  //       location: initialData?.location || "",
  //       websiteUrl: initialData?.websiteUrl || "",
  //       organizationType: initialData?.organizationType || undefined,
  //       teamSize: initialData?.teamSize || undefined,
    ...
    <Card className="w-3/4 ">
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="yearOffEstablishment">
                Year of Establishment *
              </Label>
              <div className="relative">
                <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <Input
                  id="yearOffEstablishment"
                  type="text"
                  placeholder="e.g., 2020"
                  maxLength={4}
                  className="pl-10"
                  {...register("yearOffStablishment")}
                />
              </div>
              {errors.yearOffStablishment && (
                <p className="text-sm text-destructive">
                  {errors.yearOffStablishment.message}
                </p>
              )}
            </div>
